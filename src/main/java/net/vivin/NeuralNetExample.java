...
public class NeuralNetExample {
    ...
    public static void main(String[] args) {
        ...
        Backpropagator backpropagator = new Backpropagator(untrained, 0.05);
        backpropagator.train(new double[][]{{0, 1}, {1, 0}, {1, 1}}, new double[][]{{1}, {1}, {0}});
    ...
    private static NeuralNetwork createXorNeuralNetwork() {
     ...
     private static NeuralNetwork createUntrainedXorNeuralNetwork() {
        ...
        Neuron a = new Neuron(new HyperbolicTangentActivationStrategy());
        a.setOutput(0);

        Neuron b = new Neuron(new HyperbolicTangentActivationStrategy());
        b.setOutput(0);
        ...
        Neuron hiddenA = new Neuron(new HyperbolicTangentActivationStrategy());
        Neuron hiddenB = new Neuron(new HyperbolicTangentActivationStrategy());

        hiddenLayer.addNeuron(hiddenA);
        hiddenLayer.addNeuron(hiddenB);

        Layer outputLayer = new Layer(hiddenLayer);
        Neuron xorNeuron = new Neuron(new HyperbolicTangentActivationStrategy());
